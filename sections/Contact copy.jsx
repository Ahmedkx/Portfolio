...
export default function Contact() {
    return (
        <div id="contact" className="text-white relative overflow-x-clip">
            ...
            <div className="pt-px rounded-t-lg md:rounded-t-full bg-gradient-to-r from-[#4a35c2] to-[#719abb]/50 z-10">
                <Title text="Contact" className="!my-0 py-10" />
            </div>

            <div className="flex flex-col md:px-40 container mx-auto min-w-full py-10 bg-gradient-to-r from-[#4a35c2] to-[#719abb]/50 -z-10 ">
                <div className="mx-2 flex flex-col xl:flex-row w-fit xl:w-auto place-content-between z-10 gap-20 ">
                    <div>
