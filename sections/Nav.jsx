...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 bg-[#101630] z-20">
      <div
        className={`relative ${
          scrollPosition > 50 && !open ? "border-b border-[#ffffff26]" : null
        }`}
      >
        <nav className="container mx-auto text-white z-20 flex items-center justify-between px-3 md:px-0 py-4">
          <img src="https://placehold.co/50x50" alt="logo" className="z-30" />
          {/* Burger Icon */}
          <div
...
=======
          ...
          >
            {/* <Background
>>>>>>> d98ec67572da316fef3c1de276df7c67a6794f72
            ...
            {Links.map((link) => (
              <li
                key={link.name}
                className="font-bold z-30 md:pl-8 md:py-0 py-7 border-t border-[#ffffff26] md:border-none"
              >
                <a
                  href={`#${link.link}`}
