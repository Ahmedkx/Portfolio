    ...
    <section className="container">
      <div className="overflow-hidden text-white relative h-[calc(100vh-82px)]">
        <div className="sky-body flex overflow-hidden relative h-screen">
          ...
          <div className="flex flex-col absolute top-1/3 w-full h-full font-bold">
            <h1 className="textshine text-4xl md:text-7xl">John Doe</h1>
            <h1 className="block textshine text-2xl md:text-3xl">
