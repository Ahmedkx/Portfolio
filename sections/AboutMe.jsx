            ...
            >
                ...
                <div className="flex col-span-1 flex-col justify-center mt-14 lg:mt-0 mx-10 md:mx-0">
                    ...
                    <p className=" mt-6">
                        ...
                        elit. Iste vero tempore officiis animi eligendi optio ea
                        deserunt facere quae non, possimus incidunt, unde
                        eveniet accusantium expedita quos sunt asperiores dolor.
                    </p>
